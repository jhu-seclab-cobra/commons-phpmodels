...
[![Release](https://img.shields.io/badge/release-v0.3.0-blue.svg)](https://github.com/jhu-seclab-cobra/commons-phpmodels/releases)
...
dependencies {
    implementation("com.github.jhu-seclab-cobra:commons-phpmodels:0.3.0")
}
```
...
| `ProvenanceLoader` | `load(input: InputStream): SetProvenance` | A set's `provenance.yaml`: producer and verification kind (`generated`, `manual`); read by `DocumentSetLoader` when present |
