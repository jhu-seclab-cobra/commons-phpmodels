...
[![Release](https://img.shields.io/badge/release-v0.1.0-blue.svg)](https://github.com/jhu-seclab-cobra/commons-phpmodels/releases)
...
dependencies {
    implementation("com.github.jhu-seclab-cobra:commons-phpmodels:0.1.0")
}
```
